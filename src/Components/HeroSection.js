    ...
    <div className="relative z-10 mx-auto px-4 sm:px-6 h-[100vh] min-h-[500px] flex flex-col justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col justify-center h-full mt-20">
        <motion.h1
          ...
          className="text-white text-3xl xs:text-4xl sm:text-5xl lg:text-7xl font-semibold leading-tight max-w-xl sm:max-w-2xl lg:max-w-5xl"
        >
          Western Drymix: Revolutionizing Modern Construction
        </motion.h1>
        ...
        <motion.p
          ...
          className="text-white/80 mt-6 max-w-lg sm:max-w-xl lg:max-w-4xl text-base sm:text-lg mb-10"
        >
        ...
        >
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-4 sm:p-6 flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
            ...
            <div className="text-white flex-1">
              <h3 className="text-lg sm:text-xl font-semibold">High-Performance Drymix Solutions</h3>
              ...
              <button className="mt-4 bg-green-500 hover:bg-green-600 transition px-4 py-2 sm:px-6 sm:py-2 rounded-full text-xs sm:text-base">
        ...
        {/* Arrows */}
        {/* <div className="absolute bottom-4 sm:bottom-16 left-2 sm:left-4 text-white">
        ...
        <div className="absolute bottom-4 sm:bottom-16 right-2 sm:right-4 text-white">
          <button className="border border-white/40 p-2 sm:p-3 rounded-full bg-black/30 hover:bg-black/40 transition">
            <FiChevronRight size={20} className="sm:w-auto sm:h-auto" />
          </button>
        </div> */}
      </div>
      {/* Overlay for softening the video */}
